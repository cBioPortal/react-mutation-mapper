...
describe('Civic with data with variants', () => {
    ...
    it('displays the correct Civic icon', () => {
        ...
        assert.isNotNull(civicIcon,
        "Civic icon should exist");

        assert.equal(civicIconItem.getAttribute("width"), "14",
        "Civic icon width should be equal to 14");

        assert.equal(civicIconItem.getAttribute("height"), "14",
        "Civic icon height should be equal to 14");

        assert.equal(civicIconItem.getAttribute("src"), require("../../images/civic-logo.png"),
...
describe('Civic with data with no variants', () => {
    ...
    it('displays the correct Civic icon', () => {
        ...
        assert.equal(civicIconItem.getAttribute("src"), require("../../images/civic-logo-no-variants.png"),
